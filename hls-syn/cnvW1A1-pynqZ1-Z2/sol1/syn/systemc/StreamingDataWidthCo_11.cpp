...
StreamingDataWidthCo_11::StreamingDataWidthCo_11(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, i_8_fu_54, "i_8_fu_54");
...
void StreamingDataWidthCo_11::thread_i_fu_133_p2() {
    i_fu_133_p2 = (!i_8_fu_54.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(i_8_fu_54.read()) + sc_biguint<32>(ap_const_lv32_1));
}

void StreamingDataWidthCo_11::thread_icmp_ln300_fu_119_p2() {
...
void StreamingDataWidthCo_11::thread_icmp_ln309_fu_139_p2() {
    icmp_ln309_fu_139_p2 = (!i_fu_133_p2.read().is_01() || !ap_const_lv32_100.is_01())? sc_lv<1>(): sc_lv<1>(i_fu_133_p2.read() == ap_const_lv32_100);
}
...
void StreamingDataWidthCo_11::thread_out_V_V_din() {
    out_V_V_din = esl_concat<1,255>(in_V_V_dout.read(), r_V_reg_85.read());
}
...
void StreamingDataWidthCo_11::thread_shl_ln300_fu_113_p2() {
    shl_ln300_fu_113_p2 = (!ap_const_lv32_8.is_01())? sc_lv<32>(): numReps_dout.read() << (unsigned short)ap_const_lv32_8.to_uint();
}
...
void StreamingDataWidthCo_11::thread_t_fu_124_p2() {
...
void StreamingDataWidthCo_11::thread_tmp_s_fu_159_p4() {
    tmp_s_fu_159_p4 = r_V_reg_85.read().range(254, 1);
}

void StreamingDataWidthCo_11::thread_trunc_ln_fu_169_p3() {
    trunc_ln_fu_169_p3 = esl_concat<1,254>(in_V_V_dout.read(), tmp_s_fu_159_p4.read());
}
