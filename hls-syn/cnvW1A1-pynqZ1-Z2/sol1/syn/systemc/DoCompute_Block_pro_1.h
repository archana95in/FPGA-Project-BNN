...
struct DoCompute_Block_pro_1 : public sc_module {
    ...
    sc_out< sc_lv<32> > mul_ln120_2_out_out_din;
    sc_in< sc_logic > mul_ln120_2_out_out_full_n;
    sc_out< sc_logic > mul_ln120_2_out_out_write;
    ...
    sc_signal< sc_logic > mul_ln120_2_out_out_blk_n;
    ...
    sc_signal< sc_lv<8> > grp_fu_37_p1;
    ...
    void thread_mul_ln120_2_out_out_blk_n();
    void thread_mul_ln120_2_out_out_din();
    void thread_mul_ln120_2_out_out_write();
