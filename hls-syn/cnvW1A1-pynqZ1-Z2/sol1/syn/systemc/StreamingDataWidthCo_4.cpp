...
StreamingDataWidthCo_4::StreamingDataWidthCo_4(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( icmp_ln300_reg_209 );
    sensitive << ( icmp_ln309_reg_218 );
    ...
    sensitive << ( icmp_ln300_fu_133_p2 );
    ...
    SC_METHOD(thread_icmp_ln300_fu_133_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( t_0_i_reg_101 );
    sensitive << ( totalIters_reg_204 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );

    SC_METHOD(thread_icmp_ln309_fu_153_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( icmp_ln300_fu_133_p2 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    ...
    SC_METHOD(thread_shl_ln297_2_fu_122_p2);
    sensitive << ( numReps_read_reg_198 );

    SC_METHOD(thread_shl_ln297_fu_117_p2);
    sensitive << ( numReps_read_reg_198 );
    ...
    SC_METHOD(thread_t_fu_138_p2);
    sensitive << ( t_0_i_reg_101 );

    SC_METHOD(thread_tmp_6_fu_173_p4);
    sensitive << ( r_V_reg_89 );

    SC_METHOD(thread_totalIters_fu_127_p2);
    sensitive << ( shl_ln297_fu_117_p2 );
    sensitive << ( shl_ln297_2_fu_122_p2 );

    SC_METHOD(thread_trunc_ln_fu_183_p3);
    sensitive << ( in_V_V_dout );
    sensitive << ( tmp_6_fu_173_p4 );
    ...
    sc_trace(mVcdFile, icmp_ln300_reg_209, "icmp_ln300_reg_209");
    sc_trace(mVcdFile, out_V_V_blk_n, "out_V_V_blk_n");
    sc_trace(mVcdFile, icmp_ln309_reg_218, "icmp_ln309_reg_218");
    ...
    sc_trace(mVcdFile, numReps_read_reg_198, "numReps_read_reg_198");
    sc_trace(mVcdFile, ap_block_state1, "ap_block_state1");
    sc_trace(mVcdFile, totalIters_fu_127_p2, "totalIters_fu_127_p2");
    sc_trace(mVcdFile, totalIters_reg_204, "totalIters_reg_204");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, icmp_ln300_fu_133_p2, "icmp_ln300_fu_133_p2");
    sc_trace(mVcdFile, ap_block_state3_pp0_stage0_iter0, "ap_block_state3_pp0_stage0_iter0");
    sc_trace(mVcdFile, ap_block_state4_pp0_stage0_iter1, "ap_block_state4_pp0_stage0_iter1");
    sc_trace(mVcdFile, ap_block_pp0_stage0_11001, "ap_block_pp0_stage0_11001");
    sc_trace(mVcdFile, t_fu_138_p2, "t_fu_138_p2");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter0, "ap_enable_reg_pp0_iter0");
    sc_trace(mVcdFile, icmp_ln309_fu_153_p2, "icmp_ln309_fu_153_p2");
    sc_trace(mVcdFile, trunc_ln_fu_183_p3, "trunc_ln_fu_183_p3");
    sc_trace(mVcdFile, ap_block_pp0_stage0_subdone, "ap_block_pp0_stage0_subdone");
    sc_trace(mVcdFile, ap_condition_pp0_exit_iter0_state3, "ap_condition_pp0_exit_iter0_state3");
    sc_trace(mVcdFile, i_4_fu_58, "i_4_fu_58");
    sc_trace(mVcdFile, i_fu_147_p2, "i_fu_147_p2");
    sc_trace(mVcdFile, ap_block_pp0_stage0_01001, "ap_block_pp0_stage0_01001");
    sc_trace(mVcdFile, shl_ln297_fu_117_p2, "shl_ln297_fu_117_p2");
    sc_trace(mVcdFile, shl_ln297_2_fu_122_p2, "shl_ln297_2_fu_122_p2");
    sc_trace(mVcdFile, tmp_6_fu_173_p4, "tmp_6_fu_173_p4");
...
void StreamingDataWidthCo_4::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln300_fu_133_p2.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln309_fu_153_p2.read()))) {
        i_4_fu_58 = i_fu_147_p2.read();
                ...
                (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
                 ...
                 esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && 
                 esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln300_fu_133_p2.read()) && 
                 esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln309_fu_153_p2.read())))) {
        i_4_fu_58 = ap_const_lv32_0;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
         esl_seteq<1,1,1>(icmp_ln300_reg_209.read(), ap_const_lv1_0) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        r_V_reg_89 = trunc_ln_fu_183_p3.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln300_fu_133_p2.read()))) {
        t_0_i_reg_101 = t_fu_138_p2.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        t_0_i_reg_101 = ap_const_lv32_0;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        icmp_ln300_reg_209 = icmp_ln300_fu_133_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln300_fu_133_p2.read()))) {
        icmp_ln309_reg_218 = icmp_ln309_fu_153_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, numReps_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, numReps_out_full_n.read())))) {
        numReps_read_reg_198 = numReps_dout.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        totalIters_reg_204 = totalIters_fu_127_p2.read();
    }
}
...
void StreamingDataWidthCo_4::thread_ap_block_pp0_stage0_01001() {
    ap_block_pp0_stage0_01001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(icmp_ln300_reg_209.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, in_V_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln309_reg_218.read(), ap_const_lv1_1) && 
   esl_seteq<1,1,1>(ap_const_logic_0, out_V_V_full_n.read()))));
}

void StreamingDataWidthCo_4::thread_ap_block_pp0_stage0_11001() {
    ap_block_pp0_stage0_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(icmp_ln300_reg_209.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, in_V_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln309_reg_218.read(), ap_const_lv1_1) && 
   esl_seteq<1,1,1>(ap_const_logic_0, out_V_V_full_n.read()))));
}
...
void StreamingDataWidthCo_4::thread_ap_block_pp0_stage0_subdone() {
    ap_block_pp0_stage0_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(icmp_ln300_reg_209.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, in_V_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln309_reg_218.read(), ap_const_lv1_1) && 
   esl_seteq<1,1,1>(ap_const_logic_0, out_V_V_full_n.read()))));
}
...
void StreamingDataWidthCo_4::thread_ap_block_state4_pp0_stage0_iter1() {
    ap_block_state4_pp0_stage0_iter1 = ((esl_seteq<1,1,1>(icmp_ln300_reg_209.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, in_V_V_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln309_reg_218.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(ap_const_logic_0, out_V_V_full_n.read())));
}

void StreamingDataWidthCo_4::thread_ap_condition_pp0_exit_iter0_state3() {
    if (esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln300_fu_133_p2.read())) {
...
void StreamingDataWidthCo_4::thread_i_fu_147_p2() {
    i_fu_147_p2 = (!i_4_fu_58.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(i_4_fu_58.read()) + sc_biguint<32>(ap_const_lv32_1));
}

void StreamingDataWidthCo_4::thread_icmp_ln300_fu_133_p2() {
    icmp_ln300_fu_133_p2 = (!t_0_i_reg_101.read().is_01() || !totalIters_reg_204.read().is_01())? sc_lv<1>(): sc_lv<1>(t_0_i_reg_101.read() == totalIters_reg_204.read());
}

void StreamingDataWidthCo_4::thread_icmp_ln309_fu_153_p2() {
    icmp_ln309_fu_153_p2 = (!i_fu_147_p2.read().is_01() || !ap_const_lv32_3.is_01())? sc_lv<1>(): sc_lv<1>(i_fu_147_p2.read() == ap_const_lv32_3);
}
...
void StreamingDataWidthCo_4::thread_shl_ln297_2_fu_122_p2() {
    shl_ln297_2_fu_122_p2 = (!ap_const_lv32_7.is_01())? sc_lv<32>(): numReps_read_reg_198.read() << (unsigned short)ap_const_lv32_7.to_uint();
}

void StreamingDataWidthCo_4::thread_shl_ln297_fu_117_p2() {
    shl_ln297_fu_117_p2 = (!ap_const_lv32_9.is_01())? sc_lv<32>(): numReps_read_reg_198.read() << (unsigned short)ap_const_lv32_9.to_uint();
}
...
void StreamingDataWidthCo_4::thread_t_fu_138_p2() {
    t_fu_138_p2 = (!t_0_i_reg_101.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(t_0_i_reg_101.read()) + sc_biguint<32>(ap_const_lv32_1));
}

void StreamingDataWidthCo_4::thread_tmp_6_fu_173_p4() {
    tmp_6_fu_173_p4 = r_V_reg_89.read().range(127, 64);
}

void StreamingDataWidthCo_4::thread_totalIters_fu_127_p2() {
    totalIters_fu_127_p2 = (!shl_ln297_fu_117_p2.read().is_01() || !shl_ln297_2_fu_122_p2.read().is_01())? sc_lv<32>(): (sc_biguint<32>(shl_ln297_fu_117_p2.read()) - sc_biguint<32>(shl_ln297_2_fu_122_p2.read()));
}

void StreamingDataWidthCo_4::thread_trunc_ln_fu_183_p3() {
    trunc_ln_fu_183_p3 = esl_concat<64,64>(in_V_V_dout.read(), tmp_6_fu_173_p4.read());
}
...
void StreamingDataWidthCo_4::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if (!(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln300_fu_133_p2.read()))) {
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln300_fu_133_p2.read()))) {
