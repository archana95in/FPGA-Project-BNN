...
StreamingDataWidthCo_9::StreamingDataWidthCo_9(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_1_fu_159_p4);
    sensitive << ( r_V_reg_85 );

    SC_METHOD(thread_trunc_ln_fu_169_p3);
    sensitive << ( in_V_V_dout );
    sensitive << ( tmp_1_fu_159_p4 );
    ...
    sc_trace(mVcdFile, tmp_1_fu_159_p4, "tmp_1_fu_159_p4");
...
void StreamingDataWidthCo_9::thread_i_fu_133_p2() {
    i_fu_133_p2 = (!i_1_fu_54.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(i_1_fu_54.read()) + sc_biguint<32>(ap_const_lv32_1));
}

void StreamingDataWidthCo_9::thread_icmp_ln300_fu_119_p2() {
...
void StreamingDataWidthCo_9::thread_icmp_ln309_fu_139_p2() {
...
void StreamingDataWidthCo_9::thread_shl_ln300_fu_113_p2() {
...
void StreamingDataWidthCo_9::thread_t_fu_124_p2() {
...
void StreamingDataWidthCo_9::thread_tmp_1_fu_159_p4() {
    tmp_1_fu_159_p4 = r_V_reg_85.read().range(62, 1);
}

void StreamingDataWidthCo_9::thread_trunc_ln_fu_169_p3() {
    trunc_ln_fu_169_p3 = esl_concat<1,62>(in_V_V_dout.read(), tmp_1_fu_159_p4.read());
}
