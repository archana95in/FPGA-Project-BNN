...
DoCompute_Block_pro::DoCompute_Block_pro(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_add_ln120_1_out_out_blk_n);
    sensitive << ( add_ln120_1_out_out_full_n );
    sensitive << ( ap_CS_fsm_state3 );

    SC_METHOD(thread_add_ln120_1_out_out_din);
    sensitive << ( add_ln120_1_out_out_full_n );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( add_ln120_reg_53 );

    SC_METHOD(thread_add_ln120_1_out_out_write);
    sensitive << ( add_ln120_1_out_out_full_n );
    sensitive << ( ap_CS_fsm_state3 );

    SC_METHOD(thread_add_ln120_fu_42_p2);
    sensitive << ( numReps_read_reg_47 );
    sensitive << ( shl_ln120_fu_37_p2 );
    ...
    SC_METHOD(thread_shl_ln120_fu_37_p2);
    sensitive << ( numReps_read_reg_47 );
    ...
    sc_trace(mVcdFile, add_ln120_1_out_out_din, "(port)add_ln120_1_out_out_din");
    sc_trace(mVcdFile, add_ln120_1_out_out_full_n, "(port)add_ln120_1_out_out_full_n");
    sc_trace(mVcdFile, add_ln120_1_out_out_write, "(port)add_ln120_1_out_out_write");
#endif
    ...
    sc_trace(mVcdFile, add_ln120_1_out_out_blk_n, "add_ln120_1_out_out_blk_n");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, numReps_read_reg_47, "numReps_read_reg_47");
    sc_trace(mVcdFile, ap_block_state1, "ap_block_state1");
    sc_trace(mVcdFile, add_ln120_fu_42_p2, "add_ln120_fu_42_p2");
    sc_trace(mVcdFile, add_ln120_reg_53, "add_ln120_reg_53");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, shl_ln120_fu_37_p2, "shl_ln120_fu_37_p2");
...
void DoCompute_Block_pro::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(add_ln120_1_out_out_full_n.read(), ap_const_logic_1))) {
            ap_done_reg = ap_const_logic_1;
        }
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        add_ln120_reg_53 = add_ln120_fu_42_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, numReps_empty_n.read())))) {
        numReps_read_reg_47 = numReps_dout.read();
    }
}

void DoCompute_Block_pro::thread_add_ln120_1_out_out_blk_n() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        add_ln120_1_out_out_blk_n = add_ln120_1_out_out_full_n.read();
    } else {
        add_ln120_1_out_out_blk_n = ap_const_logic_1;
    }
}

void DoCompute_Block_pro::thread_add_ln120_1_out_out_din() {
    add_ln120_1_out_out_din = add_ln120_reg_53.read();
}

void DoCompute_Block_pro::thread_add_ln120_1_out_out_write() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(add_ln120_1_out_out_full_n.read(), ap_const_logic_1))) {
        add_ln120_1_out_out_write = ap_const_logic_1;
    } else {
        add_ln120_1_out_out_write = ap_const_logic_0;
    }
}

void DoCompute_Block_pro::thread_add_ln120_fu_42_p2() {
    add_ln120_fu_42_p2 = (!numReps_read_reg_47.read().is_01() || !shl_ln120_fu_37_p2.read().is_01())? sc_lv<32>(): (sc_biguint<32>(numReps_read_reg_47.read()) + sc_biguint<32>(shl_ln120_fu_37_p2.read()));
}
...
void DoCompute_Block_pro::thread_shl_ln120_fu_37_p2() {
    shl_ln120_fu_37_p2 = (!ap_const_lv32_3.is_01())? sc_lv<32>(): numReps_read_reg_47.read() << (unsigned short)ap_const_lv32_3.to_uint();
}
...
void DoCompute_Block_pro::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(add_ln120_1_out_out_full_n.read(), ap_const_logic_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
                ap_NS_fsm = ap_ST_fsm_state3;
            }
