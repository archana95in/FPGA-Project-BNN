...
wire    grp_StreamingMaxPool_1_fu_55_ap_start;
wire    grp_StreamingMaxPool_1_fu_55_ap_done;
wire    grp_StreamingMaxPool_1_fu_55_ap_idle;
wire    grp_StreamingMaxPool_1_fu_55_ap_ready;
wire    grp_StreamingMaxPool_1_fu_55_in_V_V_read;
wire   [127:0] grp_StreamingMaxPool_1_fu_55_out_V_V_din;
wire    grp_StreamingMaxPool_1_fu_55_out_V_V_write;
reg   [31:0] rep_0_i_reg_44;
wire    ap_CS_fsm_state3;
reg    grp_StreamingMaxPool_1_fu_55_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 3'd1;
#0 grp_StreamingMaxPool_1_fu_55_ap_start_reg = 1'b0;
end

StreamingMaxPool_1 grp_StreamingMaxPool_1_fu_55(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_StreamingMaxPool_1_fu_55_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln109_fu_63_p2 == 1'd0))) begin
            grp_StreamingMaxPool_1_fu_55_ap_start_reg <= 1'b1;
        end else if ((grp_StreamingMaxPool_1_fu_55_ap_ready == 1'b1)) begin
            grp_StreamingMaxPool_1_fu_55_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((grp_StreamingMaxPool_1_fu_55_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign grp_StreamingMaxPool_1_fu_55_ap_start = grp_StreamingMaxPool_1_fu_55_ap_start_reg;

assign icmp_ln109_fu_63_p2 = ((rep_0_i_reg_44 == numReps_read_reg_74) ? 1'b1 : 1'b0);

assign numReps_out_din = numReps_dout;

assign out_V_V_din = grp_StreamingMaxPool_1_fu_55_out_V_V_din;
