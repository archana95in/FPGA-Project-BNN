...
architecture behav of StreamingDataWidthCo_17 is 
    ...
    signal p_025_0_i_reg_81 : STD_LOGIC_VECTOR (95 downto 0);
    ...
    signal ap_phi_mux_p_Val2_s_phi_fu_119_p4 : STD_LOGIC_VECTOR (127 downto 0);
    signal ap_phi_reg_pp0_iter0_p_Val2_s_reg_116 : STD_LOGIC_VECTOR (127 downto 0);
    signal ap_phi_reg_pp0_iter1_p_Val2_s_reg_116 : STD_LOGIC_VECTOR (127 downto 0);
    signal ap_phi_reg_pp0_iter2_p_Val2_s_reg_116 : STD_LOGIC_VECTOR (127 downto 0);
    signal ap_phi_reg_pp0_iter3_p_Val2_s_reg_116 : STD_LOGIC_VECTOR (127 downto 0);
    signal zext_ln268_fu_176_p1 : STD_LOGIC_VECTOR (127 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal shl_ln265_fu_125_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal shl_ln265_2_fu_130_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln268_reg_207_pp0_iter2_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                p_025_0_i_reg_81 <= ap_phi_mux_p_Val2_s_phi_fu_119_p4(127 downto 32);
            elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                    totalIters_reg_202(31 downto 6) <= totalIters_fu_135_p2(31 downto 6);
            end if;
        end if;
    end process;
    ...
    ap_phi_reg_pp0_iter0_p_Val2_s_reg_116 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    ...
    icmp_ln282_fu_158_p2 <= "1" when (o_fu_152_p2 = ap_const_lv32_4) else "0";
    ...
    select_ln282_fu_170_p3 <= 
        ...
        o_reg_216;
    shl_ln265_2_fu_130_p2 <= std_logic_vector(shift_left(unsigned(numReps_read_reg_196),to_integer(unsigned('0' & ap_const_lv32_6(31-1 downto 0)))));
    shl_ln265_fu_125_p2 <= std_logic_vector(shift_left(unsigned(numReps_read_reg_196),to_integer(unsigned('0' & ap_const_lv32_9(31-1 downto 0)))));
    ...
    totalIters_fu_135_p2 <= std_logic_vector(unsigned(shl_ln265_fu_125_p2) + unsigned(shl_ln265_2_fu_130_p2));
    zext_ln268_fu_176_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_025_0_i_reg_81),128));
end behav;
