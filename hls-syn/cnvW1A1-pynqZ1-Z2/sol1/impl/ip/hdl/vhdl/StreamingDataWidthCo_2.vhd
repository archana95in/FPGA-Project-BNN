...
architecture behav of StreamingDataWidthCo_2 is 
    ...
    signal p_025_0_i_reg_75 : STD_LOGIC_VECTOR (31 downto 0);
    signal o_0_i_reg_87 : STD_LOGIC_VECTOR (31 downto 0);
    signal t_0_i_reg_99 : STD_LOGIC_VECTOR (31 downto 0);
    signal numReps_read_reg_179 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal grp_fu_119_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal totalIters_reg_184 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal icmp_ln268_fu_124_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal o_fu_135_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal o_reg_198 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln282_fu_141_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln282_fu_153_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter1 : STD_LOGIC := '0';
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state7 : STD_LOGIC;
    signal ap_phi_mux_o_0_i_phi_fu_91_p4 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal zext_ln268_fu_159_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal grp_fu_119_p1 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    o_0_i_reg_87_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln268_reg_189 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                o_0_i_reg_87 <= select_ln282_fu_153_p3;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
    ...
    p_025_0_i_reg_75_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln268_reg_189_pp0_iter2_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                p_025_0_i_reg_75 <= ap_phi_mux_p_Val2_s_phi_fu_113_p4(63 downto 32);
            elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln268_fu_124_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                t_0_i_reg_99 <= t_fu_129_p2;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln268_reg_189 <= icmp_ln268_fu_124_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln268_reg_189 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln271_reg_208 <= icmp_ln271_fu_147_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln268_fu_124_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln282_reg_203 <= icmp_ln282_fu_141_p2;
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, numReps_empty_n, numReps_out_full_n, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter3, icmp_ln268_fu_124_p2, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter3, icmp_ln268_reg_189_pp0_iter2_reg, ap_predicate_op34_read_state9)
    begin
                ap_block_pp0_stage0_01001 <= (((icmp_ln268_reg_189_pp0_iter2_reg = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1)) or ((in_V_V_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_predicate_op34_read_state9 = ap_const_boolean_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter3, icmp_ln268_reg_189_pp0_iter2_reg, ap_predicate_op34_read_state9)
    begin
                ap_block_pp0_stage0_11001 <= (((icmp_ln268_reg_189_pp0_iter2_reg = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1)) or ((in_V_V_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_predicate_op34_read_state9 = ap_const_boolean_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter3, icmp_ln268_reg_189_pp0_iter2_reg, ap_predicate_op34_read_state9)
    begin
                ap_block_pp0_stage0_subdone <= (((icmp_ln268_reg_189_pp0_iter2_reg = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1)) or ((in_V_V_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_predicate_op34_read_state9 = ap_const_boolean_1)));
    end process;
    ...
    ap_block_state10_pp0_stage0_iter3_assign_proc : process(out_V_V_full_n, icmp_ln268_reg_189_pp0_iter2_reg)
    begin
                ap_block_state10_pp0_stage0_iter3 <= ((icmp_ln268_reg_189_pp0_iter2_reg = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0));
    end process;
    ...
    ap_condition_pp0_exit_iter0_state7_assign_proc : process(icmp_ln268_fu_124_p2)
    begin
        if ((icmp_ln268_fu_124_p2 = ap_const_lv1_1)) then 
    ...
    ap_phi_mux_o_0_i_phi_fu_91_p4_assign_proc : process(ap_block_pp0_stage0, icmp_ln268_reg_189, o_0_i_reg_87, ap_CS_fsm_pp0_stage0, select_ln282_fu_153_p3, ap_enable_reg_pp0_iter1)
    begin
        if (((icmp_ln268_reg_189 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_phi_mux_o_0_i_phi_fu_91_p4 <= select_ln282_fu_153_p3;
        else 
            ap_phi_mux_o_0_i_phi_fu_91_p4 <= o_0_i_reg_87;
        end if; 
    end process;


    ap_phi_mux_p_Val2_s_phi_fu_113_p4_assign_proc : process(icmp_ln268_reg_189_pp0_iter2_reg, icmp_ln271_reg_208_pp0_iter2_reg, ap_phi_reg_pp0_iter3_p_Val2_s_reg_110, zext_ln268_fu_159_p1)
    begin
        if (((icmp_ln268_reg_189_pp0_iter2_reg = ap_const_lv1_0) and (icmp_ln271_reg_208_pp0_iter2_reg = ap_const_lv1_0))) then 
            ap_phi_mux_p_Val2_s_phi_fu_113_p4 <= zext_ln268_fu_159_p1;
        else 
    ...
    ap_predicate_op34_read_state9_assign_proc : process(icmp_ln268_reg_189_pp0_iter1_reg, icmp_ln271_reg_208)
    begin
                ap_predicate_op34_read_state9 <= ((icmp_ln271_reg_208 = ap_const_lv1_1) and (icmp_ln268_reg_189_pp0_iter1_reg = ap_const_lv1_0));
    end process;

    ap_ready <= internal_ap_ready;
    grp_fu_119_p1 <= ap_const_lv32_188(10 - 1 downto 0);
    icmp_ln268_fu_124_p2 <= "1" when (t_0_i_reg_99 = totalIters_reg_184) else "0";
    icmp_ln271_fu_147_p2 <= "1" when (o_0_i_reg_87 = ap_const_lv32_0) else "0";
    icmp_ln282_fu_141_p2 <= "1" when (o_fu_135_p2 = ap_const_lv32_2) else "0";
    ...
    o_fu_135_p2 <= std_logic_vector(unsigned(ap_const_lv32_1) + unsigned(ap_phi_mux_o_0_i_phi_fu_91_p4));
    ...
    out_V_V_din <= ap_phi_mux_p_Val2_s_phi_fu_113_p4(32 - 1 downto 0);
    ...
    t_fu_129_p2 <= std_logic_vector(unsigned(t_0_i_reg_99) + unsigned(ap_const_lv32_1));
    zext_ln268_fu_159_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_025_0_i_reg_75),64));
end behav;
