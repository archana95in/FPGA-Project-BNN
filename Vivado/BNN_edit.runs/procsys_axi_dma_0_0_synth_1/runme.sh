...
HD_PWD='C:/Users/Archana Narayanan/Desktop/BNN_project/BNN_edit/BNN_edit.runs/procsys_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log procsys_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source procsys_axi_dma_0_0.tcl
